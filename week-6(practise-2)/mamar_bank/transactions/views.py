...
def transaction_mail(user,subject,template,amount):
...
class DepositeMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self,form):
        ...
        transaction_mail(self.request.user,"Deposite Massage",'transactions/deposite_mail.html',amount)
...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self,form):
        ...
        if not flag:
            ...
            transaction_mail(self.request.user,"Withdraw Massage",'transactions/withdraw_mail.html',amount)
            return super().form_valid(form)
        else:
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if send_account.balance >= amount:
                ...
                subject = "Transfer Money Another Account"
                to_mail = request.user.email
                message = render_to_string('transactions/transfer_mail.html',{
                    'user': request.user,
                    'amount':amount,
                    'receiver': receiver,
                })
